...
<h2><a href="result.php">Talaba nomeri.</a></h2>
</header>
<form name="form1" method="post" action="result.php">
  <p>
    <label for="textfield2">No</label>
...
<article class="post">
  <header class="postheader">
    <h2>Ism va kursi bo'yicha qidirish</h2>
  </header>
  <form name="form2" method="post" action="">
    <p>
      <label for="textfield3">Ism</label>
      <input type="text" name="textfield2" id="textfield3">
      </p>
    <p>
      <label for="select">Kurs</label>
   <?php
...
<form name="form2" method="post" action="viewresult.php">
  <table width="501" border="1">
    ...
    <tr>
      <td width="136"><strong>Id Talaba</strong></td>
      <td width="88"><strong>Ism</strong></td>
      <td width="80"><strong>Otasining ismi</strong></td>
      <td width="73"><strong>Semester</strong></td>
      <td width="90"><strong>natija</strong></td>
    </tr>
